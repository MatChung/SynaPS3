...
int deSELF(int argc, char *argv[]) // usage: in.self out.elf
...
void patchSELF(char self_path[256], char target_path[256], char* string1, char* string2) {
	decryptSELF(self_path, target_path);
	replaceString(target_path, string1, string2);
	encryptSELF(target_path);
}
